    ...
    <?php require_once("header.php"); ?>
        ...
        <div id="info">
          <h2 id="oddil_napis"> Oddíl badmintonu </h2>
            ...
            <p>Oddíl badmintonu TJ Sokol Plzeň Doubravka pořádá každoročně množství turnajů od místní, přes regionální k republikové i mezinárodní úrovni. Některé z nich jsou určeny pro hráče s výkonnostními ambicemi, jiné pro rekreanty. Na některých z nich lze vidět republikovou či krajskou špičku příslušné věkové kategorie, na jiných spíš snahu a úsilí než kvalitní sportovní výkon.</p>

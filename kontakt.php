...
<html>
    ...
    <link href="css/styl_kontakt.css" rel="stylesheet">
    ...
    <?php require_once("header.php"); ?>
          ...
          <h2 id="progres_nadpis"> Kontaktuje nás! </h2>
          ...
          <div class="flex_kontakt">
            ...
            <div class="person_flex">
              ...
              <a href="mailto:m.karas.ing@seznam.cz"><p class="email_kontakt">m.karas.ing@seznam.cz</p></a>
            ...
            <div class="person_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:miladanovakova@centrum.cz"><p class="email_kontakt">miladanovakova@centrum.cz</p></a>
            ...
            <div class="person_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:j.faist@seznam.cz"><p class="email_kontakt">j.faist@seznam.cz</p></a>
          ...
          <h2 id="progres_nadpis"> Sportovní oddíly </h2>

          <div class="flex_kontakt_odd">
            ...
            <div class="person_odd_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:brychta.jaromir@email.cz"><p class="email_kontakt_odd">brychta.jaromir@email.cz</p></a>
            ...
            <div class="person_odd_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:prokopva@plzen.eu"><p class="email_kontakt_odd">prokopva@plzen.eu</p></a>
            ...
            <div class="person_odd_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:ladas2013@seznam.cz"><p class="email_kontakt_odd">ladas2013@seznam.cz</p></a>
            ...
            <div class="person_odd_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:v.palek@volny.cz"><p class="email_kontakt_odd">v.palek@volny.cz</p></a>
            ...
            <div class="person_odd_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:jan.kopp@email.cz"><p class="email_kontakt_odd">jan.kopp@email.cz</p></a>
          ...
          <h2 id="progres_nadpis"> Ostatní </h2>

          <div class="flex_kontakt_ost">
            ...
            <div class="person_odd_flex">
              ...
              <img src="img/obalka_icon.png" alt="obálka">
              <a href="mailto:a.sestakova@seznam.cz"><p class="email_kontakt_odd">a.sestakova@seznam.cz</p></a>

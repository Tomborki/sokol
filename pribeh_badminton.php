...
<link rel="icon" href="img/favicon-sokol.png" sizes="20x20">
      ...
      <?php require_once("header.php"); ?>
          ...
          <div class="pribeh_container">
                <h2 id="nadpis_pribeh">Za opeřeným míčkem </h2>
               ...
               <h2 class="like"> Osobnosti </h2>
                  <section class="rodic_social_osob">
      	             ...
      	             <article class="flex_social_osob">
                        <div class="osobnost">
                         <img class="foto_osob" src="img/osobnosti/hucl.jpg" alt="Jaromír Hucl">
                         <h2>Jaromír Hucl</h2>
                         <p>Na otázku, proč se chce stát trenérem, odpověděl na trenérském školení v Hustopečích před několika roky: "Sám jsem toho jako hráč moc neuhrál, tak bych chtěl alespoň nějakého hráče vychovat". Není to tak úplně pravda. V žákovském věku stál "na bedně" dokonce i na Mistrovství republiky a v současné době je oporou družstva dospělých, hlavně v párových disciplinách. Především se ale postupně stává jedním z pilířů akcí, které oddíl organizuje, pevným článkem trenérského týmu a vedení oddílu. Kromě už zmíněného trenérského školení absolvoval i školení rozhodčích. Bez problémů zvládá řízení turnajů. Pomůže, když je třeba, zapojí se nejenom radou, ale i vlastní prací. Je na něj zkrátka spolehnutí a jako předseda oddílu je pro všechny dobrým příkladem.</p>
                       </div>
                        <div class="osobnost">
                         <img class="foto_osob" src="img/osobnosti/spurny.gif" alt=" Jiří Spurný (roč. 1975) - Profesor ">
                         <h2>Jiří Spurný (roč. 1975) - Profesor</h2>
                         <p>Členem našeho oddílu se stal v r. 1989. Mnohonásobný krajský přeborník ve všech disciplinách, velmi brzy několikanásobný vítěz Přeborů ČR, Mistrovství ČR a ČSFR. Mezinárodní mistr Polska, vítěz mnoha turnajů na úrovni oblasti i republiky. Říkali o něm, že má údery dopředu propočtené, obdivovali jeho schopnost tvořit hru, udržet míč ve hře, jeho herní inteligenci, důslednost při trestání chyb soupeře, houževnatost a vůli. Byl samostatný, někdy až příliš. Ctižádost ho hnala k vyšším výkonům a systematické přípravě a dávala mu zapomenout na jistá omezení daná jeho tělesnou kontrukcí. Potíže se zády ho předčasně (ještě před hranicí dospělosti) zastavily v rozletu.</p>
                       </div>
                       <div class="osobnost">
                         <img class="foto_osob" src="img/osobnosti/sobotaml.jpg" alt="Jaroslav Sobota ml. (roč. 1979) - Sobol">
                         <h2>Jaroslav Sobota ml. (roč. 1979) - Sobol</h2>
                         <p>První medaili z republikových přeborů (zlatou) získal jako mladší žák s P. Holečkem. I další medaile byly ze čtyřhry (mladší dorost 1996 - bronz s J. Vedralem, starší dorost 1997 - stříbro s J. Vedralem, 1998 - bronz s M. Skočdopolem), ačkoli se vždycky zdálo, že předpoklady má spíše pro dvouhru. Získal spoustu titulů Přeborník oblasti v různých věkových kategoriích a disciplínách. Poctivost a vytrvalost v přípravě, zkušenosti získané během hostování v druholigovém Slavoji Plzeň a německém SG Post Süd Regensburg, trvalá podpora ze strany rodičů - to vše jsou základy jeho badmintonového umění. V sezóně 2000/01 se dostal ve dvouhře na 10. místo průběžného žebříčku dospělých, což je zatím jeho nejlepší umístění. Na začátku sezóny 2001/2002 přestoupil do prvoligového celku USK Zentiva Plzeň. </p>
                       </div>
                       <div class="osobnost">
                         <img class="foto_osob" src="img/osobnosti/prindaml.jpg" alt="Jan Přinda ml. (roč. 1983) - Macík">
                         <h2>Jan Přinda ml. (roč. 1983) - Macík</h2>
                         <p>S prvním zlatem na krku se vrátil z Mistrovství ČR mladšího žactva v r. 1995 a totéž zopakoval o dva roky později na M ČR staršího žactva. Se stejným spoluhráčem (Jakub Urban) dosáhl na medailové umístění i potřetí - v r. 1999 v kategorii mladšího dorostu (bronz), když rok předtím Jakuba stejně úspěšně zastoupil O.Chlad. Největší medailový zisk přinesla sezóna 1999/2000: Na M ČR U17 získal Honza zlato ve čtyřhře (s Kohoutkem-Č.Krumlov), stříbro v mixu (s Kocourkovou-Dobruška) a bronz ve dvouhře. Na M ČR U19 startoval ve čtyřhře opět s Jakubem Urbanem a byl z toho opět bronz. Honzík má za sebou také první mezinárodní zkušenosti - mezi nejvýznamnější patří start na ME družstev kategorie do 17 let (Polonia Cup) a pokud mu píle vydrží, čekají ho jistě mnohé další starty. Pro párové discipliny má patrně předpoklady...</p>
                       </div>
